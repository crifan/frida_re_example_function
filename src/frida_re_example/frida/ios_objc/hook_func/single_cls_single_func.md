...
如之前 [ObjC的参数 · 逆向调试利器：Frida](https://book.crifan.org/books/reverse_debug_frida/website/use_frida/frida_cli/ios_objc/objc_para.html) 中的`计算ObjC的函数的真正参数的个数 + 打印全部参数`的实例代码，加到此处，略作调整变成：
